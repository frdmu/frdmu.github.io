...
### Todo
&ensp;&ensp;We’ve defined the type for you and provided some helper functions (see wrapping integers.hh), but you’ll implement the conversions in wrapping integers.cc:
```c++
...
```
&ensp;&ensp;Hint:The cleanest/easiest implementation will use the helper functions provided in wrapping integers.hh. The wrap/unwrap operations should preserve offsets—two seqnos that differ by 17 will correspond to two absolute seqnos that also differ by 17.
